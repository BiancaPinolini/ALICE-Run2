#ifndef ALIANALYSISTASKNUCLEI_H
#define ALIANALYSISTASKNUCLEI_H
...
//class AliPPVsMultUtils; //for Run 1
...
class AliAnalysisTaskNuclei : public AliAnalysisTaskSE {
 ...
 private:
  ...
  AliAnalysisTaskNuclei(const AliAnalysisTaskNuclei &old);
  AliAnalysisTaskNuclei& operator=(const AliAnalysisTaskNuclei &source);
  ...
  //AliPPVsMultUtils *fPPVsMultUtils;               //  for multiplicity estimator (Run 1)
  ...
  TH1F *hnCrossedRowsTPC[2];                      //! crossed rows
  TH1F *hRatioCrossedRowsOverFindableClustersTPC[2];  //!ratio
  ...
  void TrackSelectionMonitor(Float_t nCrossedRowsTPC, Float_t RatioCrossedRowsOverFindableClustersTPC, Double_t chi2TPC, Bool_t isTPCrefit, Bool_t isITSrefit, Int_t nSPD, Int_t nKinkDaughters, Double_t chi2ITS, Bool_t isPropagatedToDca, Double_t DCAxy, Double_t DCAz, Double_t eta);
